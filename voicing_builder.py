...
from midi_engine.chords import reproducir_acorde_threaded, reproducir_notas_secuenciales_threaded, reproducir_notas_ordenadas_threaded
...
class VoicingBuilderGUI:
    ...
    # ---------------- on_voicing_click: carga root + notas en "voicing actual" ---------------
